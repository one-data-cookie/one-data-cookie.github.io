...
## Text
- [ChatGPT](https://chatgpt.com/): needs no intro
- [Claude](https://claude.ai/): also needs no intro these days
- [Poe](https://poe.com/): universal AI messaging app, mostly for cloud and commercial models
- [LM Studio Bionic](https://lmstudio.ai/): local-first AI agent for open models, similar to what Poe does for commercial models
...
- [nvidia/parakeet](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3): all the good, fast, small, and open ASR models of today built off it
...
- [Openclaw](https://openclaw.im/) or [Clawdbot](https://clawd.bot/) previously: open-source framework that lets developers build AI-powered automations, esp. through messengers
    ...
    - Much better might be using [NanoClaw](https://github.com/qwibitai/nanoclaw), the secure and light-weight one, or [Hermes](https://github.com/NousResearch/hermes-agent), the memory-rich and self-improving one
- [rentahuman.ai](https://rentahuman.ai/): AI agents rent humans for tasks they cannot do themselves
- [agent-browser](https://github.com/vercel-labs/agent-browser): more capable alternative to browser mcp, also [chrome-cdp](https://github.com/pasky/chrome-cdp-skill)
- [agent-messenger](https://github.com/agent-messenger/agent-messenger): messenger automation via agents
- [hunk](https://github.com/modem-dev/hunk): review-first terminal diff viewer for agentic coders
- [Orca](https://www.onorca.dev/): the Agent IDE (ADE), i.e. desktop IDE for running multiple AI coding agents OR "GitHub + Cursor + tmux, built around multiple autonomous agents"
...
- [Pi.dev](https://pi.dev/): minimal, hackable, plugin-driven, multi-LLM agent harness
- [OMP](https://omp.sh/): the batteries-included version of Pi
